        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.dragons.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="dob" id="dob" value="{{ old('dob') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div>
                                ...
                                <select name="morph" id="morph" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                    ...
                                    @foreach($morphs as $morph)
                                        <option value="{{ $morph }}" {{ old('morph') === $morph ? 'selected' : '' }}>{{ $morph }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="weight" id="weight" value="{{ old('weight') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="price" id="price" value="{{ old('price') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div>
                                ...
                                <select name="status" id="status" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                    ...
                                    <option value="breeding_stock" {{ old('status') === 'breeding_stock' ? 'selected' : '' }}>Breeding Stock</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="clutch_id" id="clutch_id" value="{{ old('clutch_id') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div>
                                ...
                                <select name="parent_male_id" id="parent_male_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                    ...
                                    @foreach($dragons->where('sex', 'male') as $male)
                                        <option value="{{ $male->id }}">{{ $male->name ?? 'Unnamed' }} - {{ $male->morph }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="parent_female_id" id="parent_female_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                    ...
                                    @foreach($dragons->where('sex', 'female') as $female)
                                        <option value="{{ $female->id }}">{{ $female->name ?? 'Unnamed' }} - {{ $female->morph }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="date" name="date_listed" id="date_listed" value="{{ old('date_listed') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                                @error('date_listed') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>

                            <!-- Hidden -->
                            <div class="flex items-center">
                                <input type="checkbox" name="is_hidden" id="is_hidden" value="1" {{ old('is_hidden') ? 'checked' : '' }} class="rounded border-gray-300">
                        ...
                        <!-- Images -->
                        <div class="mt-6">
                            <label for="images" class="block text-sm font-medium text-gray-700">Images (first will be primary)</label>
