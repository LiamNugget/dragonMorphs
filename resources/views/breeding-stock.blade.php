...
@section('title', 'Breeding Stock')

@section('content')
<div class="title_text" style="margin-top: 2rem;">
    <h1><i class="fas fa-star"></i> Our Breeding Stock</h1>
</div>

<div class="text_box_green" style="margin-top: 2rem;">
    <p style="text-align: center;">These are our top quality breeding dragons. They are not for sale but we are proud to showcase the genetics we are working with. Offspring from these dragons are regularly available in our morphs section. Click on any dragon to see their full gallery and details.</p>
</div>
                ...
                <div class="stock_details">
                    ...
                    <div class="card_footer">
                        <span class="status_badge">
                            <i class="fas fa-heart"></i> Breeding Stock
                        </span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="modal-header">
                            ...
                            <div class="modal-info-grid">
                                ...
                                <div class="modal-info-item">
                                    ...
                                    <span class="modal-info-value">Breeding Stock</span>
                                </div>
                                @if($dragon->clutch_id)
                                    <div class="modal-info-item">
